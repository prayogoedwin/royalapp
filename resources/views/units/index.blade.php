    ...
    <div class="mb-6 space-y-3">
        ...
        <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    <h3 class="text-sm font-semibold text-yellow-800 dark:text-yellow-200 mb-2">KIR Segera Jatuh Tempo ({{ $upcomingKirUnits->count() }} unit)</h3>
                    <ul class="space-y-1">
                        ...
                        <li class="text-sm text-yellow-700 dark:text-yellow-300">
                            ...
                            <span class="font-semibold">({{ abs($unit->daysUntilKirRenewal()) }} hari lagi)</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
